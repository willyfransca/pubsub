...
public class Message1 implements Comparable<Message1> {
	...
	static {
		reset();
		DTNSim.registerForReset(Message1.class.getCanonicalName());
	}
	 ...
	 */
	public Message1(DTNHost from, DTNHost to, String id, int size) {
		this.from = from;
		this.to = to;
		this.id = id;
		this.size = size;
	 ...
	 */
	public void setRequest(Message1 request) {
	 ...
	 */
	protected void copyFrom(Message1 m) {
	 ...
	 */
	public Message1 replicate() {
		Message1 m = new Message1(from, to, id, size);
		m.copyFrom(this);
		return m;
	}
	 ...
	 */
	public int compareTo(Message1 m) {
