...
public abstract class MessageRouter {
    ...
    public static final int Q_MODE_SHORT = 3;
    public static final int Q_MODE_LONG = 4;
    public static final int Q_HOP = 5;
    public static final int Q_POPULARITY = 6;
     ...
     */
    HashMap<String, Message> deliveredMessages;
    /**
    ...
    public MessageRouter(Settings s) {
        ...
        if (s.contains(SEND_QUEUE_MODE_S)) {
            ...
            if (sendQueueMode < 1 || sendQueueMode > 7) {
...
//        nodeInterest = s.getSetting("nodeList");
        ...
        //mengambil status node sebagai publiser/subscriber
    ...
    public void init(DTNHost host, List<MessageListener> mListeners) {
        System.setProperty("java.util.Arrays.useLegencyMergeSort", "true");
...
//            }
//        }
//        if (temp[1].contains(Integer.toString(host.getAddress()))) {
//            this.status = temp[0];
//        } else if (temp1[1].contains(Integer.toString(host.getAddress()))) {
//            this.status = temp1[0];
//        } else {
//            this.status = "relay";
//        }
            ...
            case Q_POPULARITY:
                Collections.sort(list,
                    ...
                    public int compare(Object o1, Object o2) {
                        ...
                        Integer pesan1, pesan2;
                        if (m1.getProperty("popularity") != null && m2.getProperty("popularity") != null) {
                            
                            pesan1 = (Integer) m1.getProperty("popularity");
                            pesan2 = (Integer) m2.getProperty("popularity");
                            diff = pesan1 - pesan2;
                        }
                        if (diff == 0) {
                            return 0;
    ...
    protected int compareByQueueMode(Message m1, Message m2) {
        switch (sendQueueMode) {
            ...
            case Q_MODE_SHORT:
                double cek = m1.getTtl() - m2.getTtl();
                if (cek == 0) {
                    return 0;
                }
                return (cek < 0 ? -1 : 1);
