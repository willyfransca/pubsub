 ...
 * @author asus
 */
public class latencyReport1 extends Report implements MessageListener, UpdateListener {
    ...
    public void messageTransferred(Message m, DTNHost from, DTNHost to, boolean firstDelivery) {
       ...
       if(firstDelivery){
          double total= SimClock.getTime()-m.getCreationTime();
           temp = (temp+total)/2;
       }
...
//        }
    ...
    public void updated(List<DTNHost> hosts) {
        ...
        if (simTime - lastRecord >= interval) {
            write(SimClock.getIntTime()+"\t"+temp);
